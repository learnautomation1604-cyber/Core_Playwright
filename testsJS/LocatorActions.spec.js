...
//     await page.waitForTimeout(3000);
//     await page.locator("//span[@class='srp-format-tabs-h2'][normalize-space()='Buy It Now']").press('Enter');
//     await page.waitForTimeout(5000);
// })

// test("tap Action", async({page}) =>{
//     await page.goto("https://www.ebay.com");
...
// });
// test("focus Action", async({page}) =>{
//     await page.goto("https://www.ebay.com");
//     await page.waitForTimeout(6000);
//     await page.locator("input#gh-ac").fill("i Phone 16 Pro");
//     await page.waitForTimeout(3000);
//     await page.locator("//button[@id='gh-search-btn']").focus();
//     await page.waitForTimeout(3000);
//     await page.locator("//button[@id='gh-search-btn']").blur();
//     await page.waitForTimeout(3000);
//     await page.locator("//button[@id='gh-search-btn']").highlight();
...
// press('Enter'), Press('Down'), press('Tab')
//focus()
// blur()
// SelectOption(values)
